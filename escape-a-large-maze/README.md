<h2>1036. Escape a Large Maze</h2><h3>Hard</h3><hr><div><p>There is a 1 million by 1 million grid on an XY-plane, and the coordinates of each grid square are <code>(x, y)</code>.</p>
